        ...
        <div className='bg-themeDark text-white p-4 pt-8 pb-32 mt-24 w-full flex justify-center text-center'>
            <div className='w-page'>
                <div className='py-4 flex justify-between flex-wrap gap-4'>
                    <Button as={Link} className='min-w-[100px] max-w-[200px]' to='/category/type=aid'>Home</Button>
                    ...
                    <Button as={Link} className='min-w-[100px] max-w-[200px]' to='/advertise'>Committee</Button>
